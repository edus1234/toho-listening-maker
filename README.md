...
### 🎉 最新機能 (v2.4.6 - 2025-11-14)
1. **フォルダ内テスト再生修正** 🐛: フォルダに保存されたテストの音声再生が正常に動作するよう修正
2. **「スクリプト編集に戻る」ボタン修正** 🐛: 音声編集画面から正しくスクリプト確認画面に戻れるよう修正
...
### 本番環境
- **ステータス**: ✅ 稼働中
- **最終更新**: 2025-11-14 (v2.4.6 - フォルダ再生と戻るボタン修正)
- **URL**: **https://toho-listening-maker.pages.dev** (メインドメイン)
- **最新デプロイ**: https://f35d5d63.toho-listening-maker.pages.dev
